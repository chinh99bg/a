...
function connect(){
	...
	mysqli_select_db($link,'cnweb') or die('Could not select database.');
...
function upload_file_by_name($name, $target_dir=""){
	...
	$URL = 'http://localhost/TT/webbanhangquanao/login/doashboard/';
	...
	return 'http://localhost/TT/webbanhangquanao/login/doashboard/' . $target_file;
	}
	return "";
   }
